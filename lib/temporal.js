...
module.exports = {
    ...
    get TemporalPatternDetector() {
        return tinyalephModule?.TemporalPatternDetector || class TemporalPatternDetectorFallback {};
    },

    get Moment() {
        return tinyalephModule?.Moment || class MomentFallback {};
    },
