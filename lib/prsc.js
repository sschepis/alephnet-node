...
class PRSCFallback {
    ...
    amplitudeEntropy() { return 0.5; }
    totalEnergy() { return 0.5; }
    activePrimes(threshold) { return []; }
    getPhases() { return this.phases; }
    orderParameter() { return 0.5; }
    toSemanticState() { return { state: new Map() }; }
    getOscillator(prime) { return null; }
    getAmplitudes() { return this.amplitudes; }
}
...
module.exports = {
    ...
    get PRSCLayer() {
        return tinyalephModule?.PRSCLayer || tinyalephModule?.PrimeResonanceSemanticComputation || PRSCFallback;
    },

    get PrimeOscillator() {
        return tinyalephModule?.PrimeOscillator || class PrimeOscillatorFallback {};
    },

    get EntanglementDetector() {
        return tinyalephModule?.EntanglementDetector || class EntanglementDetectorFallback {};
    },
