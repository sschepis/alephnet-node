...
class BoundaryLayerFallback {
    ...
    updateSelf(smf, status) {}
    processInput(channel, content) {}
    getReadyOutputs() { return []; }
...
module.exports = {
    ...
    get SelfModel() {
        return tinyalephModule?.SelfModel || class SelfModelFallback {};
    },

    get EnvironmentalModel() {
        return tinyalephModule?.EnvironmentalModel || class EnvironmentalModelFallback {};
    },
